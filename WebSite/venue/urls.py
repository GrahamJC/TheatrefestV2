...
urlpatterns = [
    ...
    path('performance/<uuid:performance_uuid>/sale/<uuid:sale_uuid>/payment/cash', views.sale_payment_cash, name = 'sale_payment_cash'),
    path('performance/<uuid:performance_uuid>/sale/<uuid:sale_uuid>/payment/card', views.sale_payment_card, name = 'sale_payment_card'),
    path('performance/<uuid:performance_uuid>/sale/<uuid:sale_uuid>/payment/cancel', views.sale_payment_cancel, name = 'sale_payment_cancel'),
    path('performance/<uuid:performance_uuid>/sale/<uuid:sale_uuid>/complete/cash', views.sale_complete_cash, name = 'sale_complete_cash'),
